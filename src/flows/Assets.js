...
function Assets() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get('https://api.p360.build:6060/v1/fundflow/asset-funds/fetchAll', Cookie);
...
//     // createdBy: 'System User', // Replace with the desired system-generated value for createdBy
//     // submittedBy: 'System User', // Replace with the desired system-generated value for submittedBy
//   });
// };
const handleAddClick = () => {
  setIsAddingRow(true);
  ...
  // Retrieve user information using the imported function
...
const updateRowInDatabase = async (updatedRowData) => {
  try {
    ...
    const response = await axios.put(
      `https://api.p360.build:6060/v1/fundflow/asset-funds/submit`, // Update the API endpoint with the row's unique identifier (id)
      {
